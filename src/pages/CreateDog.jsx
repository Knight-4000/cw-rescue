...
export default function CreateDog() {
  ...
  return (
    ...
    <main className="max-w-md px-2 mx-auto">
       <h1 className="text-2xl text-center mt-8 font-bold">Add your dog</h1>
      ...
      <p className="text-lg font-semibold">Kids</p>
        ...
        <p className="text-lg font-semibold">Cats</p>
          <textarea
            type="text"
            id="cats"
            value={cats}
        ...
        active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Create Dog</button>
      </form>
    </main>
